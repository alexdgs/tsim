 ...
 * @author Jose
 */
public class MejorOpcion implements Serializable{
    ...
    public boolean comparar(Object[][] tabla, Datos datos){
        boolean seMejora = false;
        if(tabla[0].length > 10 && tabla[tabla.length-1][tabla[0].length-1] != null){
            ...
            //comparamos opciones:
            //si la nueva simulacion tiene un mejor ingreso que la mejor hasta ahora,
